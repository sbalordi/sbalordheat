    ...
    <body class="bg-image mainBody d-flex h-100 text-center flex-column overflow-scroll">
      ...
      <div class="container w-100 p-4 bg-black">
        ...
        <div class="d-flex flex-column">
          <p>Benvenuti su SbalordHEAT, un punto di riferimento nell'innovazione energetica e nella sostenibilità ambientale. Fondata con l'obiettivo di ridefinire il concetto di produzione energetica, ci impegniamo a promuovere un futuro più verde e sostenibile.</p>
