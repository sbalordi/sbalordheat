...
<style>
    ...
    * {
    ...
    @media (max-width: 600px) {
        ...
        .mainBody {
          background: linear-gradient(0deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 30%, rgba(0,0,0,0.90) 50%, rgba(0,0,0,0.40) 100%), url("https://static.ohga.it/wp-content/uploads/sites/24/2019/06/iStock-476697500.jpg");
          background-size: cover;
        }
    }
</style>
